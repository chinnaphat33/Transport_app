...
class checkparcelscreen extends StatefulWidget {
  const checkparcelscreen({Key? key}) : super(key: key);

  @override
  State<checkparcelscreen> createState() => _checkparcelscreenState();
}

class _checkparcelscreenState extends State<checkparcelscreen> {
